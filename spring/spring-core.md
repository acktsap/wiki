...
### “소규모 애플리케이션 또는 기업용 애플리케이션을 자바로 개발하는데 있어 유용하고 편리한
...
● 스프링 5 부터는 WebFlux 지원으로 서블릿 기반이 아닌 서버 애플리케이션도 개발할
수 있게 됨.
```
### 디자인 철학
...
사용하는 ​의존의존 객체를객체를 직접직접 만들어만들어 사용하는게사용하는게 아니라아니라 **,** 주입주입 받아받아 사용하는사용하는 방법​방법​을 말 함.
...
● BeanFactory
● 애플리케이션 컴포넌트의 중앙 저장소.
● 빈빈 설정설정 소스​소스​로 부터 ​빈빈 정의​정의​를 읽어들이고, ​빈을빈을 구성하고구성하고 제공​제공​한다.
```
### 빈
...
## 4. IoC 컨테이너 2 부: ApplicationContext와
...
## 6. IoC 컨테이너 4 부: @Component와 컴포넌트
...
## 8. IoC 컨테이너 6 부: Environment 1부. 프로파일
...
## 9. IoC 컨테이너 6 부: Environment 2부. 프로퍼티
...
## 11. IoC 컨테이너 8 부: ApplicationEventPublisher
...
## 12. IoC 컨테이너 9 부: ResourceLoader
