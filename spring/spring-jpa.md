...
- [스프링 데이터 JPA](#%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-jpa)
  - [Core Concept](#core-concept)
    ...
    - [Fetch](#fetch)
    - [Query](#query)
    - [13. Spring Data JPA Principle](#13-spring-data-jpa-principle)
    - [14. JPA Basic Summary](#14-jpa-basic-summary)
  - [Spring Data JPA](#spring-data-jpa)
    ...
    - [17. 스프링 데이터 Common: Repository 인터페이스 정의하기](#17-%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-common-repository-%ec%9d%b8%ed%84%b0%ed%8e%98%ec%9d%b4%ec%8a%a4-%ec%a0%95%ec%9d%98%ed%95%98%ea%b8%b0)
    ...
    - [22. 스프링 데이터 Common: 커스텀 리포지토리](#22-%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-common-%ec%bb%a4%ec%8a%a4%ed%85%80-%eb%a6%ac%ed%8f%ac%ec%a7%80%ed%86%a0%eb%a6%ac)
    - [23. 스프링 데이터 Common: 기본 리포지토리 커스터마이징](#23-%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-common-%ea%b8%b0%eb%b3%b8-%eb%a6%ac%ed%8f%ac%ec%a7%80%ed%86%a0%eb%a6%ac-%ec%bb%a4%ec%8a%a4%ed%84%b0%eb%a7%88%ec%9d%b4%ec%a7%95)
    ...
    - [26. 스프링 데이터 Common: Web 1부: 웹 지원 기능 소개](#26-%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-common-web-1%eb%b6%80-%ec%9b%b9-%ec%a7%80%ec%9b%90-%ea%b8%b0%eb%8a%a5-%ec%86%8c%ea%b0%9c)
    - [27. 스프링 데이터 Common: Web 2 부: DomainClassConverter](#27-%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-common-web-2-%eb%b6%80-domainclassconverter)
    - [28. 스프링 데이터 Common: Web 3 부: Pageable과 Sort 매개변수](#28-%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-common-web-3-%eb%b6%80-pageable%ea%b3%bc-sort-%eb%a7%a4%ea%b0%9c%eb%b3%80%ec%88%98)
    - [29. 스프링 데이터 Common: Web 4 부: HATEOAS](#29-%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-common-web-4-%eb%b6%80-hateoas)
    ...
    - [35. 스프링 데이터 JPA: Named Parameter과 SpEL](#35-%ec%8a%a4%ed%94%84%eb%a7%81-%eb%8d%b0%ec%9d%b4%ed%84%b0-jpa-named-parameter%ea%b3%bc-spel)
...
- 주인이 아닌쪽(`@OneToMany`쪽)에서 mappedBy 사용해서 관계를 맺고 있는 필드를 설정해야 합니다.
...
![spring-jpa-repository](./img/spring-jpa-repository.png)
...
### 27. 스프링 데이터 Common: Web 2 부: DomainClassConverter
...
### 28. 스프링 데이터 Common: Web 3 부: Pageable과 Sort 매개변수
...
### 29. 스프링 데이터 Common: Web 4 부: HATEOAS
...
![entitymanager-persist](./img/entitymanager-persist.png)
...
![entitymanager-merge](./img/entitymanager-merge.png)
...
QBE는 필드 이름을 작성할 필요 없이(뻥) 단순한 인터페이스를 통해 동적으로 쿼리를 만드는 기능을 제공하는 사용자 친화적인 쿼리 기술입니다. (감이 1 도 안잡히는거 이해합니다.. 코드를 봐야 이해하실꺼에요.)
