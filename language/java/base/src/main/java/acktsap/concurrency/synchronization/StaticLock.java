...
package acktsap.concurrency.synchronization;
...
public class StaticLock {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final Runnable runnable = () -> IntStream.range(0, tryCount)
        ...
        System.out
            .format("After execution: %d (%d expected)%n", Counter.staticValue(), 2 * tryCount);
    }
