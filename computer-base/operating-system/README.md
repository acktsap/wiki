...
- [Operating System](#operating-system)
  ...
  - [Memory Management](#memory-management)
    ...
    - [Virtual Memory](#virtual-memory)
      - [프로그램의 일부분만 메모리에 올릴 수 있다면...](#%ed%94%84%eb%a1%9c%ea%b7%b8%eb%9e%a8%ec%9d%98-%ec%9d%bc%eb%b6%80%eb%b6%84%eb%a7%8c-%eb%a9%94%eb%aa%a8%eb%a6%ac%ec%97%90-%ec%98%ac%eb%a6%b4-%ec%88%98-%ec%9e%88%eb%8b%a4%eb%a9%b4)
    - [가상 메모리가 하는 일](#%ea%b0%80%ec%83%81-%eb%a9%94%eb%aa%a8%eb%a6%ac%ea%b0%80-%ed%95%98%eb%8a%94-%ec%9d%bc)
      - [가상 주소 공간](#%ea%b0%80%ec%83%81-%ec%a3%bc%ec%86%8c-%ea%b3%b5%ea%b0%84)
      - [프로세스간의 페이지 공유](#%ed%94%84%eb%a1%9c%ec%84%b8%ec%8a%a4%ea%b0%84%ec%9d%98-%ed%8e%98%ec%9d%b4%ec%a7%80-%ea%b3%b5%ec%9c%a0)
    - [Demand Paging(요구 페이징)](#demand-paging%ec%9a%94%ea%b5%ac-%ed%8e%98%ec%9d%b4%ec%a7%95)
      - [Page fault trap(페이지 부재 트랩)](#page-fault-trap%ed%8e%98%ec%9d%b4%ec%a7%80-%eb%b6%80%ec%9e%ac-%ed%8a%b8%eb%9e%a9)
    - [페이지 교체](#%ed%8e%98%ec%9d%b4%ec%a7%80-%ea%b5%90%ec%b2%b4)
      - [기본적인 방법](#%ea%b8%b0%eb%b3%b8%ec%a0%81%ec%9d%b8-%eb%b0%a9%eb%b2%95)
      - [페이지 교체 알고리즘](#%ed%8e%98%ec%9d%b4%ec%a7%80-%ea%b5%90%ec%b2%b4-%ec%95%8c%ea%b3%a0%eb%a6%ac%ec%a6%98)
        - [FIFO 페이지 교체](#fifo-%ed%8e%98%ec%9d%b4%ec%a7%80-%ea%b5%90%ec%b2%b4)
        - [최적 페이지 교체(Optimal Page Replacement)](#%ec%b5%9c%ec%a0%81-%ed%8e%98%ec%9d%b4%ec%a7%80-%ea%b5%90%ec%b2%b4optimal-page-replacement)
        - [LRU 페이지 교체(LRU Page Replacement)](#lru-%ed%8e%98%ec%9d%b4%ec%a7%80-%ea%b5%90%ec%b2%b4lru-page-replacement)
        - [LFU 페이지 교체(LFU Page Replacement)](#lfu-%ed%8e%98%ec%9d%b4%ec%a7%80-%ea%b5%90%ec%b2%b4lfu-page-replacement)
        - [MFU 페이지 교체(MFU Page Replacement)](#mfu-%ed%8e%98%ec%9d%b4%ec%a7%80-%ea%b5%90%ec%b2%b4mfu-page-replacement)
...
- Internal Fragmentation: 프로세스가 사용하는 메모리 공간 에 포함된 남는 부분. 예를들어 프로세스세 할당된 메모리 공간이 10,000B 있고 Process A 가 9,998B 사용하게되면 2B 라는 차이가 존재하게된다.

| `Process A` | free | `Process B` | free | `Process C` | &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; free &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; | `Process D` |
| ----------- | ---- | ----------- | ---- | ----------- | :--------------------------------------------------------------------------------------: | ----------- |

- Compaction : 외부 단편화를 해소하기 위해 프로세스가 사용하는 공간들을 한쪽으로 몰아, 자유공간을 확보하는 방법론 이지만, 작업효율이 좋지 않다.
