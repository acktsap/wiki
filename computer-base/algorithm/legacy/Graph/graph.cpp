...
====== Graph ======
    ...
    Implementation of the graph
        ...
        What to use?
        Tip?
    Graph & real world problems[feel it]
 ...
 o Graph?
    ...
    Represents relation among objects
 ...
 o Type of Graph
    ...
    directed graph :  O ------> O
    undirected graph : O ------- O
    weighted graph : O ---15---> O
    single graph : O ------- O		// one line
    multigraph : O ====== O		// two lines
    unrooted graph : looks like a tree
    biparite graph : edges exist among other groups
                    O	O	O	// group 1
                    | / | / |
                    O	O	O	// group 2
